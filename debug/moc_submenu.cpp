...
QT_MOC_LITERAL(3, 15, 11), // "setChallege"
QT_MOC_LITERAL(4, 27, 3), // "num"
QT_MOC_LITERAL(5, 31, 7) // "setHelp"

    },
    "SubMenu\0begin\0\0setChallege\0num\0setHelp"
};
...
void SubMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SubMenu *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->begin(); break;
        case 1: _t->setChallege((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->setHelp((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject SubMenu::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_SubMenu.data,
    qt_meta_data_SubMenu,
    qt_static_metacall,
    nullptr,
    nullptr
} };
